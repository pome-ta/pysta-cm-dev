...
// CodeMirrorのプロトタイプにメソッドを設定して、編集者のドキュメントにリダイレクトします。
...
// 追加の引数はモードの依存関係として保存され、loadmode.jsのような（レガシー）メカニズムがモードを自動的にロードするために使用します。  （推奨されるメカニズムはrequire / define呼び出しです。）
